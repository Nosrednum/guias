...
1. Modelo multidimensional asociado al proceso de movimientos de inventarios, disponible en este [enlace](./Img/Modelo%20movimiento.png)
...
1. **Práctica 1 - Manejo de historia:** Identifique cuáles técnicas de manejo de historia se podrían usar y actualice el modelo multimensional con base en el tipo de manejo que más adelante le sugerimos
...
Practique con uno de los escenarios. Las tablas con la información para cada escenario se llaman ClientesReporte2_Escenario1 y ClientesReporte2_Escenario2. Adicionalmente, reflexione sobre el impacto, a nivel de la tabla de hechos, el tener movimientos de inventario del segundo semestre del 2016.
